  ...
  return (
    <button
      ...
      className={`tw-relative tw-px-2 tw-py-3 tw-text-white tw-font-bold tw-border-none tw-rounded-t-lg hover:tw-cursor-pointer ${
        isActive
          ? 'tw-bg-col-table-header after:tw-shadow-roundedTabRightActive before:tw-shadow-roundedTabLeftActive tw-z-20'
          : 'tw-bg-col-table-header-trans after:tw-shadow-roundedTabRightPassive before:tw-shadow-roundedTabLeftPassive'
      }
